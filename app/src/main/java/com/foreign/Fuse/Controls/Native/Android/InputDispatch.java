...
public class InputDispatch
{
    ...
    public static void ClearOnTouchListener159(final Object viewHandle)
    {
    ...
    public static Object CreateTouchListener160()
    {
        return new android.view.View.OnTouchListener() {
        		public boolean onTouch(android.view.View view, android.view.MotionEvent e) {
        			return ExternedBlockHost.callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch161((Object)view,(Object)e,UnoHelper.GetUnoObjectRef((Object)view),UnoHelper.GetUnoObjectRef((Object)e));
        		}
        	};
    }
    
    public static void SetOnTouchListener162(final Object viewHandle,final Object listenerHandle)
    {
