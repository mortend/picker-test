// This file was generated based on '../Source/Fuse.Controls.Primitives/TextControls/TextControl.GraphicsText.uno'.
...
struct TextControl : ::g::Fuse::Controls::LayoutControl
{
    ...
    static ::g::Uno::UX::Selector MaxLinesPropertyName_;
    static ::g::Uno::UX::Selector& MaxLinesPropertyName() { return TextControl_typeof()->Init(), MaxLinesPropertyName_; }
    ...
    void TextScaleFactorChanged(float textScaleFactor);
