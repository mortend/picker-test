...
struct IWebView
{
    ...
    void(*fp_add_BeginDownload)(uObject*, uDelegate*);
    void(*fp_remove_BeginDownload)(uObject*, uDelegate*);
    ...
    void(*fp_add_FileDownloaded)(uObject*, uDelegate*);
    void(*fp_remove_FileDownloaded)(uObject*, uDelegate*);
    ...
    static void add_BeginDownload(const uInterface& __this, uDelegate* value) { __this.VTable<IWebView>()->fp_add_BeginDownload(__this, value); }
    static void remove_BeginDownload(const uInterface& __this, uDelegate* value) { __this.VTable<IWebView>()->fp_remove_BeginDownload(__this, value); }
    ...
    static void add_FileDownloaded(const uInterface& __this, uDelegate* value) { __this.VTable<IWebView>()->fp_add_FileDownloaded(__this, value); }
    static void remove_FileDownloaded(const uInterface& __this, uDelegate* value) { __this.VTable<IWebView>()->fp_remove_FileDownloaded(__this, value); }
