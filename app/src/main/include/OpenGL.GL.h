// This file was generated based on '../node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/OpenGL/GL.uno'.
...
struct GL : uObject
{
    ...
    static void BufferData(int32_t target, int32_t sizeInBytes, void* data, int32_t usage);
    static void BufferSubData(int32_t target, int32_t offset, int32_t sizeInBytes, void* data);
    ...
    static void TexImage2D(int32_t target, int32_t level, int32_t internalFormat, int32_t width, int32_t height, int32_t border, int32_t format, int32_t type, void* data);
