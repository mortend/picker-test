// This file was generated based on '../Source/Fuse.Selection/IsSelected.uno'.
...
struct IsSelectedFunction__OuterSubscription : ::g::Fuse::Reactive::VarArgFunction__Subscription
{
    ...
    void ctor_3(::g::Fuse::Selection::IsSelectedFunction* expr, uObject* listener, ::g::Fuse::Node* from);
    void CleanListener();
    void CleanPending();
