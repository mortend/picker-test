// This file was generated based on '../Source/Fuse.Drawing/Stroke.uno'.
...
struct Stroke : ::g::Uno::UX::PropertyObject
{
    ...
    static ::g::Uno::UX::Selector& _dashedSizeName() { return Stroke_typeof()->Init(), _dashedSizeName_; }
    ...
    void SetDashedSize(float dashedSize, uObject* origin);
    void Unpin();
    float Width();
