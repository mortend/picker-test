...
void Console__LogInternal_fn(::g::Fuse::Scripting::Context* context, uArray* args, int32_t* level, uObject** __retval);
...
struct Console : uObject
{
    ...
    static uObject* LogInternal(::g::Fuse::Scripting::Context* context, uArray* args, int32_t level);
