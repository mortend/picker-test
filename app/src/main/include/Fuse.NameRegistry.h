// This file was generated based on '../Source/Fuse.Nodes/NameRegistry.uno'.
...
void NameRegistry__RemoveListener_fn(::g::Uno::UX::Selector* name, uObject* listener);
...
struct NameRegistry : uObject
{
    ...
    static void RemoveListener(::g::Uno::UX::Selector name, uObject* listener);
