// This file was generated based on '../node_modules/@fuse-open/uno/lib/build/Uno.Threading/2.2.0/ConcurrentDictionary.uno'.
...
struct ConcurrentDictionary : uObject
{
    ...
    void Add1(::g::Uno::Collections::KeyValuePair<TKey, TValue> keyValue) { ConcurrentDictionary__Add1_fn(this, uConstrain(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(__type->T(0), __type->T(1), nullptr), keyValue)); }
    void Clear();
    template<class TKey, class TValue>
    bool Contains(::g::Uno::Collections::KeyValuePair<TKey, TValue> keyValue) { bool __retval; return ConcurrentDictionary__Contains_fn(this, uConstrain(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(__type->T(0), __type->T(1), nullptr), keyValue), &__retval), __retval; }
    template<class TKey>
    ...
    template<class TKey, class TValue>
    bool Remove1(::g::Uno::Collections::KeyValuePair<TKey, TValue> keyValue) { bool __retval; return ConcurrentDictionary__Remove1_fn(this, uConstrain(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(__type->T(0), __type->T(1), nullptr), keyValue), &__retval), __retval; }
    template<class TKey, class TValue>
