// This file was generated based on '../Source/Fuse.Controls.WebView/Android/WebView.uno'.
...
{
    uStrong< ::g::Java::Object*> _downloadListenerHandle;
    ...
    bool _ScrollEnabled;
    bool _ZoomEnabled;
    uStrong<uDelegate*> BeginDownload1;
    uStrong<uDelegate*> BeginLoading1;
    uStrong<uDelegate*> FileDownloaded1;
    ...
    void add_BeginDownload(uDelegate* value);
    void remove_BeginDownload(uDelegate* value);
    ...
    void add_FileDownloaded(uDelegate* value);
    void remove_FileDownloaded(uDelegate* value);
    void GoBack();
    void GoForward();
    ...
    void OnBeginDownload(uString* url);
    void OnBeginloading();
    void OnCustomURI(uString* url);
    void OnFileDownloaded(uString* url, uString* path);
