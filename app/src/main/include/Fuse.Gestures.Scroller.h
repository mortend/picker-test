// This file was generated based on '../Source/Fuse.Controls.ScrollView/Scroller.uno'.
...
struct Scroller : ::g::Fuse::Behavior
{
    ...
    void OnPointerWheelMoved(uObject* sender, ::g::Fuse::Input::PointerWheelMovedArgs* args);
    ...
    static Scroller* New2(bool ignore);
};
// }
