// This file was generated based on '../node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/Graphics/OpenGL/GLDrawCall.uno'.
...
namespace g{namespace Uno{namespace Graphics{namespace OpenGL{struct GLDrawCall;}}}}
...
struct GLDrawCall
{
    ...
    uStrong< ::g::Uno::Graphics::OpenGL::GLCompiledProgram*> _compiledProgram;
    int32_t _blendEqRgb;
    ...
    float _LineWidth;
    uStrong< ::g::Uno::Graphics::OpenGL::GLProgram*> _Program;
    bool _WriteAlpha;
    bool _WriteBlue;
    bool _WriteDepth;
    bool _WriteGreen;
    ...
    void ctor_1(::g::Uno::Graphics::OpenGL::GLProgram* program);
    ...
    ::g::Uno::Graphics::OpenGL::GLProgram* Program();
    void Program(::g::Uno::Graphics::OpenGL::GLProgram* value);
