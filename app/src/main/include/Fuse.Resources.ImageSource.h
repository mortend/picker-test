// This file was generated based on '../Source/Fuse.Elements/Resources/ImageSource.uno'.
...
{
    void(*fp_GetBytes)(::g::Fuse::Resources::ImageSource*, uArray**);
    void(*fp_GetTexture)(::g::Fuse::Resources::ImageSource*, ::g::Uno::Graphics::Texture2D**);
    void(*fp_Load)(::g::Fuse::Resources::ImageSource*);
...
struct ImageSource : ::g::Uno::UX::PropertyObject
{
    ...
    uArray* GetBytes() { uArray* __retval; return (((ImageSource_type*)__type)->fp_GetBytes)(this, &__retval), __retval; }
    ...
    bool IsPinned();
    void Load() { (((ImageSource_type*)__type)->fp_Load)(this); }
    void OnChanged();
    ...
    void Unpin();
    static void Load(ImageSource* __this) { ImageSource__Load_fn(__this); }
