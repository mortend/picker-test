// This file was generated based on '../Source/Fuse.Platform/Android/SystemUI.uno'.
...
{
    static float _textScaleFactor_;
    static float& _textScaleFactor() { return SystemUI_typeof()->Init(), _textScaleFactor_; }
    ...
    static int32_t _statusbarStyle_;
    static int32_t& _statusbarStyle() { return SystemUI_typeof()->Init(), _statusbarStyle_; }
    ...
    static uSStrong<uDelegate*> DeviceOrientationChanged1_;
    static uSStrong<uDelegate*>& DeviceOrientationChanged1() { return SystemUI_typeof()->Init(), DeviceOrientationChanged1_; }
    ...
    static uSStrong<uDelegate*> TextScaleFactorChanged1_;
    static uSStrong<uDelegate*>& TextScaleFactorChanged1() { return SystemUI_typeof()->Init(), TextScaleFactorChanged1_; }
    ...
    static int32_t GetCurrentScreenOrientation();
    ...
    static void SetCurrentScreenOrientation(int32_t orientation);
    static bool SetDarkStatusBarStyle();
    static void SetFrame(::g::Java::Object* view, int32_t originX, int32_t originY, int32_t height);
    static bool SetLightStatusBarStyle();
    static bool SetStatusBarColor(int32_t color);
    static void ShowStatusBar();
    static void unoOnGlobalLayout();
    static void UpdateStatusBar();
    static void UpdateTextScaleFactor(float _textScaleFactor1);
    ...
    static void DeviceOrientation(int32_t value);
    ...
    static float TextScaleFactor();
    static void TextScaleFactor(float value);
    static ::g::Uno::Rect TopFrame();
    static void add_DeviceOrientationChanged(uDelegate* value);
    static void remove_DeviceOrientationChanged(uDelegate* value);
    ...
    static void add_TextScaleFactorChanged(uDelegate* value);
    static void remove_TextScaleFactorChanged(uDelegate* value);
};
// }
