// This file was generated based on '../Source/Fuse.Controls.Primitives/TextControls/FallbackTextRenderer/TextRenderer.uno'.
...
struct TextRenderer : uObject
{
    ...
    static ::g::Uno::Graphics::Utils::Text::FontFace* LoadFont(::g::Fuse::Font* font);
