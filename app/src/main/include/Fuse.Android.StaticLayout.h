// This file was generated based on '../Source/Fuse.Android.TextRenderer/Internal/StaticLayout.uno'.
...
struct StaticLayout : uObject
{
    ...
    void ctor_1(uString* text, ::g::Fuse::Android::TextPaint* paint, int32_t width, int32_t align, float spacingMult, float spacingAdd, bool includePad, int32_t maxLines);
    ...
    static ::g::Java::Object* Create1(uString* text, ::g::Java::Object* paintHandle, int32_t width, int32_t align, float spacingMult, float spacingAdd, bool includePad, int32_t maxLines);
    ...
    static StaticLayout* New2(uString* text, ::g::Fuse::Android::TextPaint* paint, int32_t width, int32_t align, float spacingMult, float spacingAdd, bool includePad, int32_t maxLines);
