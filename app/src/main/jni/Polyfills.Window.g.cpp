...
// /Users/morten/fuse-open/fuselibs/Source/Polyfills.Window/WindowModule.uno
// -------------------------------------------------------------------------
...
void WindowModule::ctor_3()
{
    ...
    if (WindowModule::_instance_ == nullptr)
...
{
    if (WindowModule::_fileSourceInstance_ == nullptr)
