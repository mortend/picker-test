...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Controls/Graphics/ControlVisual.uno
// --------------------------------------------------------------------------------
...
static void ControlVisual_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), nullptr), offsetof(ControlVisual_type, interface0),
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), nullptr), offsetof(ControlVisual_type, interface5),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), nullptr), offsetof(ControlVisual_type, interface6),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), nullptr), offsetof(ControlVisual_type, interface7),
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), nullptr), offsetof(ControlVisual_type, interface10),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), nullptr), offsetof(ControlVisual_type, interface11),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), nullptr), offsetof(ControlVisual_type, interface12));
    type->SetFields(70,
...
void ControlVisual__FindControl_fn(ControlVisual* __this, uTRef __retval)
{
    ...
    return __retval.Store(__this->__type->GetBase(ControlVisual_typeof())->T(0), uT(__this->__type->GetBase(ControlVisual_typeof())->T(0), alloca(__this->__type->GetBase(ControlVisual_typeof())->T(0)->ValueSize))), void();
}
...
{
    uT ret1(__this->__type->GetBase(ControlVisual_typeof())->T(0), alloca(__this->__type->GetBase(ControlVisual_typeof())->T(0)->ValueSize));
    ::g::Fuse::Visual__OnRooted_fn(__this);
    __this->_control() = (ControlVisual__FindControl_fn(__this, &ret1), ret1);

    if (uBoxPtr(__this->__type->GetBase(ControlVisual_typeof())->T(0), __this->_control()) == nullptr)
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Controls/Graphics/Visual.uno
// -------------------------------------------------------------------------
...
static void Visual_build(uType* type)
{
    type->SetDependencies(
        ::g::Fuse::VisualBounds_typeof());
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), nullptr), offsetof(::g::Fuse::Visual_type, interface0),
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), nullptr), offsetof(::g::Fuse::Visual_type, interface5),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), nullptr), offsetof(::g::Fuse::Visual_type, interface6),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), nullptr), offsetof(::g::Fuse::Visual_type, interface7),
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), nullptr), offsetof(::g::Fuse::Visual_type, interface10),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), nullptr), offsetof(::g::Fuse::Visual_type, interface11),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), nullptr), offsetof(::g::Fuse::Visual_type, interface12));
    type->SetFields(68,
