...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Reactive.Bindings/Internal/PatchList.uno
// -------------------------------------------------------------------------------------
...
static void PatchList_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Reactive::Internal::PatchItem_typeof(), nullptr);
    ::TYPES[2] = ::g::Uno::Collections::ICollection_typeof();
    type->MethodTypes[0]->SetPrecalc(
        type->MakeMethod(1/*PatchRemoveAll<T>*/, type->MethodTypes[0]->U(0), nullptr),
        ::TYPES[0/*Fuse.Reactive.Internal.SimpleAlgorithm`1*/]->MakeType(type->MethodTypes[0]->U(0), nullptr));
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[2/*Uno.Collections.ICollection`1*/]->MakeType(type->MethodTypes[1]->U(0), nullptr));
}
...
{
    type->SetPrecalc(
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(type->T(0), ::g::Uno::Int_typeof(), nullptr),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(type->T(0), nullptr),
        ::g::Uno::Collections::IList_typeof()->MakeType(type->T(0), nullptr));
    type->SetFields(0,
        ::g::Uno::Collections::IList_typeof()->MakeType(type->T(0), nullptr), offsetof(SimpleAlgorithm, _from), 0,
        ::g::Uno::Collections::IList_typeof()->MakeType(type->T(0), nullptr), offsetof(SimpleAlgorithm, _to), 0,
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(type->T(0), ::g::Uno::Int_typeof(), nullptr), offsetof(SimpleAlgorithm, _toIndex), 0,
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Bool_typeof(), nullptr), offsetof(SimpleAlgorithm, _toUsed), 0,
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Reactive::Internal::PatchItem_typeof(), nullptr), offsetof(SimpleAlgorithm, _ops), 0,
...
void SimpleAlgorithm__ctor__fn(SimpleAlgorithm* __this, uObject* from, uObject* to, void* emptyKey)
{
    ...
    __this->_toUsed = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Bool_typeof(), nullptr), ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(to), __types[0]))));
