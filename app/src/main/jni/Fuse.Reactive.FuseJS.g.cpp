...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/FuseJS/Http.uno
// ---------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/FuseJS/Builtins.uno
// -------------------------------------------------------------------------------------
...
static void Builtins_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), nullptr);
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::setTimeout80a8de06())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);

    if ((setTimout != nullptr) && (Builtins::_timer_ != nullptr))
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::es6promisemin11b10212())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Diagnostics6b26da95()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Observable5e5b61c7()))->EvaluateExports(context, ::STRINGS[6/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    TreeObservable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::TreeObservablea407670a()))->EvaluateExports(context, ::STRINGS[7/*"FuseJS/Tree...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/FuseJS/Timer.uno
// ----------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/FuseJS/DiagnosticsImpl.uno
// --------------------------------------------------------------------------------------------
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/FuseJS/DiagnosticsImpl.uno");
    ::STRINGS[18] = uString::Const("Report");
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[6] = ::g::Fuse::Marshal_typeof()->MakeMethod(0/*ToType<Fuse.DiagnosticType>*/, ::g::Fuse::DiagnosticType_typeof(), nullptr);
    ::TYPES[7] = ::g::Fuse::Marshal_typeof()->MakeMethod(0/*ToType<string>*/, ::g::Uno::String_typeof(), nullptr);
    type->SetDependencies(
        ::g::Uno::UX::Resource_typeof());
    type->SetInterfaces(
...
void DiagnosticsImplModule::ctor_2()
{
    ...
    if (DiagnosticsImplModule::_instance_ != nullptr)
        return;
...
uObject* DiagnosticsImplModule::Report(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Report requ...*/], this, ::STRINGS[17/*"/Users/mort...*/], 30, ::STRINGS[18/*"Report"*/]);
        return nullptr;
    }
    ...
    ::g::Fuse::Diagnostics::Report(::g::Fuse::Diagnostic::New1(type, msg, nullptr, nullptr, 0, nullptr, nullptr));
    return nullptr;
}
...
static void Http__FuseJSHttpRequest_build(uType* type)
{
    ...
    ::TYPES[10] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), nullptr);
    ::TYPES[11] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), ::g::Uno::String_typeof(), nullptr);
    ::TYPES[12] = ::g::Uno::Action4_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof(), nullptr);
    ::TYPES[8] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[13] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(0/*FromAction<int>*/, ::g::Uno::Int_typeof(), nullptr);
    ::TYPES[14] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Int_typeof(), nullptr);
    ::TYPES[15] = ::g::Uno::Action_typeof();
    ::TYPES[16] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(1/*FromAction<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), nullptr);
    ::TYPES[17] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), nullptr);
    ::TYPES[18] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(3/*FromFunc<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), nullptr);
    ::TYPES[19] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), nullptr);
    ::TYPES[20] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(2/*FromFunc<string>*/, ::g::Uno::String_typeof(), nullptr);
    ::TYPES[21] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::String_typeof(), nullptr);
    ::TYPES[22] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(2/*FromFunc<int>*/, ::g::Uno::Int_typeof(), nullptr);
    ::TYPES[23] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::Int_typeof(), nullptr);
...
void Http__FuseJSHttpRequest::DetachRequest()
{
    ...
    if (_finalState == 5)
    {
        ...
        switch (uPtr(_req)->HttpResponseType())
        {
            case 1:
            {
                GetResponseContentByteArray(_context, nullptr);
                break;
            }
            case 0:
            {
                GetResponseContentString(_context, nullptr);
                break;
            }
        }
    }
...
{
    if (_cachedResponseContent == nullptr)
    {
        CheckIsAttached();
...
uString* Http__FuseJSHttpRequest::GetResponseContentString(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    if (::g::Uno::String::op_Equality(contentAsString, nullptr))
        U_THROW(::g::Uno::Net::Http::InvalidResponseTypeException::New4());
...
uString* Http__FuseJSHttpRequest::GetResponseHeader(uString* key)
{
    ...
    if (::g::Uno::String::op_Equality(_cachedResponseHeaders, nullptr))
...
{
    return uBox<int32_t>(::TYPES[27/*int*/], (_req != nullptr) ? uPtr(_req)->State() : _finalState);
}
...
{
    if ((args != nullptr) && (uPtr(args)->Length() > 0))
    {
        ...
        else
        {
            ...
            if ((obj != nullptr) && (uPtr(obj)->Item(::STRINGS[42/*"buffer"*/]) != nullptr))
            {
...
static void HttpHeaders_build(uType* type)
{
    ...
    ::TYPES[28] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::String_typeof(), nullptr), nullptr);
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[30] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(5/*ToArray<string>*/, ::g::Uno::String_typeof(), nullptr);
    ::TYPES[31] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[32] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof(), nullptr);
    ::TYPES[33] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), nullptr);
    ::TYPES[34] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::String_typeof(), nullptr);
    type->SetFields(0,
        ...
        {
            {
                ...
                while (::g::Uno::String::op_Inequality(headerLine, nullptr))
                {
...
{
    ::g::Fuse::Scripting::IThreadWorker::Invoke1(uInterface(uPtr(_worker), ::g::Fuse::Scripting::IThreadWorker_typeof()), uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), nullptr), (void*)Http__HttpJSDispatcher__ActionClosure__Run_fn, Http__HttpJSDispatcher__ActionClosure::New1(action)));
}
...
static void TimerManager__Timer_build(uType* type)
{
    type->SetFields(0,
        ...
        ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), nullptr), offsetof(TimerManager__Timer, _callback), 0,
        ...
        ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Int_typeof(), nullptr), offsetof(TimerManager__Timer, OnStop), 0,
...
void TimerManager__Timer::Stop()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(OnStop, nullptr))
...
bool TimerManager__Timer::Update(::g::Fuse::Scripting::Context* context)
{
    ...
    if (_timeout <= elapsed)
    {
...

        {
            ...
            {
                {
                    if (::g::Uno::Delegate::op_Inequality(_callback, nullptr))
...
{
    type->SetFields(0,
        ::g::Uno::Collections::List_typeof()->MakeType(TimerManager__Timer_typeof(), nullptr), offsetof(TimerManager, _timers), 0);
}
...
{
    _timers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::g::Uno::Collections::List_typeof()->MakeType(TimerManager__Timer_typeof(), nullptr)));
}
...
void TimerModule::ctor_2()
{
    ...
    if (TimerModule::_instance_ != nullptr)
        return;
...
uObject* TimerModule::Create(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    return uBox<int32_t>(::TYPES[27/*int*/], uPtr(_tm)->AddTimer(ms, uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), nullptr), (void*)TimerModule__CallbackClosure__Callback_fn, TimerModule__CallbackClosure::New1(context, func, innerArgs)), repeat));
}
...
uObject* TimerModule::Destroy(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::g::Fuse::MarshalException_typeof()))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Timer.destroy(): The parameter is not a valid timer handle"), this, uString::Const("/Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/FuseJS/Timer.uno"), 138, uString::Const("Destroy"));
        }
        else         throw __t;
    }
