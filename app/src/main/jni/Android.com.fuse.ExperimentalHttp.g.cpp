...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/Uno.Net.Http/2.2.0/Implementation/Android/ExperimentalHttp/HttpRequest.uno
// -------------------------------------------------------------------------------------------------------------------------------------------------
...
void HttpRequest::ctor_4(uObject* arg0, uObject* arg1, uObject* arg2)
{
    ...
    HttpRequest* wrapper = _subclassed ? this : nullptr;
...
void HttpRequest::_InitProxy1()
{
    ...
    INIT_JNI;
    HttpRequest::_javaProxyClass1_ = NEW_GLOBAL_REF(jclass,::g::Android::Base::JNI::LoadClass(jni, "com.foreign.Android_com_fuse_ExperimentalHttp_HttpRequest"));
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
...
{
    INIT_JNI;
    jobject _obArg2 = ((!arg2_) ? nullptr : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    uObject* result;
    CLASS_INIT(HttpRequest::_javaClass1_,HttpRequest::_Init1());
...
jobject HttpRequest::HttpRequest_IMPL_44284(uObject* arg0_, uObject* arg1_, uObject* arg2_, uObject* arg3_)
{
    ...
    jobject _obArg1 = ((!arg1_) ? nullptr : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg1_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    jobject _obArg2 = ((!arg2_) ? nullptr : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    jobject _obArg3 = ((!arg3_) ? nullptr : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg3_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    jobject result;
    jobject _tmp;
    if (!arg0_) {
...
{
    INIT_JNI;
    jobject _obArg0 = ((!arg0_) ? nullptr : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg0_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
    CLASS_INIT(HttpRequest::_javaClass1_,HttpRequest::_Init1());
