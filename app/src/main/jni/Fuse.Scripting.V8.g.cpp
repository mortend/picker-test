...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/V8/Array.uno
// ------------------------------------------------------------------------------
...
{
    if ((__this->_context != nullptr) && !uPtr(__this->_context)->IsDisposed())
...
void Array__Equals2_fn(Array* __this, ::g::Fuse::Scripting::Array* a, bool* __retval)
{
    ...
    return *__retval = (that != nullptr) && uBox(::g::Fuse::Scripting::V8::Simple::JSArray_typeof(), (ind1 = __this->_array, ind1), alloca(::g::Fuse::Scripting::V8::Simple::JSArray_typeof()->ObjectSize))->Equals(uBox(::g::Fuse::Scripting::V8::Simple::JSArray_typeof(), uPtr(that)->_array)), void();
}
...
{
    ::JSArray* ind2;
    return *__retval = uBox(::g::Fuse::Scripting::V8::Simple::JSArray_typeof(), (ind2 = __this->_array, ind2), alloca(::g::Fuse::Scripting::V8::Simple::JSArray_typeof()->ObjectSize))->GetHashCode(), void();
}
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/V8/Handle.uno
// -------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/V8/V8SimpleExtensions.uno
// -------------------------------------------------------------------------------------------
...
{
    ::TYPES[1] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::V8::Simple::JSValue_typeof(), nullptr);
    ::TYPES[2] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::V8::Simple::JSValue_typeof(), nullptr);
    type->SetDependencies(
        ::g::Fuse::Scripting::V8::V8SimpleExtensions_typeof());
    type->SetInterfaces(
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/V8/Context.uno
// --------------------------------------------------------------------------------
        ...
        {
            {
                ...
                catch (const uThrowable& __t)
                {
                    ...
                    {
                        if (uPtr(_context)->_cachedException == nullptr)
...
static void Context_build(uType* type)
{
    ...
    type->SetFields(10,
        ...
        ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::V8::Simple::JSScriptException_typeof(), nullptr), offsetof(Context, _errorHandler), 0,
...
void Context__Evaluate_fn(Context* __this, uString* fileName, uString* code, uObject** __retval)
{
    ...
    if (::g::Uno::String::op_Equality(code, nullptr))
...
{
    ctor_1();
    _errorHandler = uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::V8::Simple::JSScriptException_typeof(), nullptr), (void*)Context__OnScriptException_fn, this);
...
void Context::ThrowPendingExceptions()
{
    if (_vmDepth == 0)
    {
        if (_cachedException != nullptr)
        {
            ::g::Uno::Exception* e = _cachedException;
            _cachedException = nullptr;
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/V8/Function.uno
// ---------------------------------------------------------------------------------
...
void Function__Construct_fn(Function* __this, ::g::Fuse::Scripting::Context* context, uArray* args, ::g::Fuse::Scripting::Object** __retval)
{
    ...
    ::JSContext* cxt = uPtr(__this->_context)->_context;
    ::g::Fuse::Scripting::V8::Object* result = nullptr;
    ::g::Fuse::Scripting::V8::AutoReleasePool pool = ::g::Fuse::Scripting::V8::AutoReleasePool__New1(cxt);
...
void Function__Equals2_fn(Function* __this, ::g::Fuse::Scripting::Function* f, bool* __retval)
{
    ...
    return *__retval = (that != nullptr) && uBox(::g::Fuse::Scripting::V8::Simple::JSFunction_typeof(), (ind1 = __this->_function, ind1), alloca(::g::Fuse::Scripting::V8::Simple::JSFunction_typeof()->ObjectSize))->Equals(uBox(::g::Fuse::Scripting::V8::Simple::JSFunction_typeof(), uPtr(that)->_function)), void();
}
...
{
    ::JSFunction* ind2;
    return *__retval = uBox(::g::Fuse::Scripting::V8::Simple::JSFunction_typeof(), (ind2 = __this->_function, ind2), alloca(::g::Fuse::Scripting::V8::Simple::JSFunction_typeof()->ObjectSize))->GetHashCode(), void();
}
...
uArray* Marshaller::TryGetArrayBufferData(::g::Fuse::Scripting::V8::Context* context, ::g::Fuse::Scripting::V8::Object* o)
{
    ...
    if (o->ContainsKey(uString::Const("__unoHandle")))
    {
        ...
        ::g::Fuse::Scripting::V8::ArrayHandle* handle = (ext == nullptr) ? uCast< ::g::Fuse::Scripting::V8::ArrayHandle*>(nullptr, ::g::Fuse::Scripting::V8::ArrayHandle_typeof()) : uAs< ::g::Fuse::Scripting::V8::ArrayHandle*>(uPtr(ext)->Object, ::g::Fuse::Scripting::V8::ArrayHandle_typeof());
...
{
    int32_t len = (values == nullptr) ? 0 : uPtr(values)->Length();
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Scripting.JavaScript/V8/Object.uno
// -------------------------------------------------------------------------------
...
void Object__Equals2_fn(Object* __this, ::g::Fuse::Scripting::Object* o, bool* __retval)
{
    ...
    return *__retval = (that != nullptr) && uBox(::g::Fuse::Scripting::V8::Simple::JSObject_typeof(), (ind1 = __this->_object, ind1), alloca(::g::Fuse::Scripting::V8::Simple::JSObject_typeof()->ObjectSize))->Equals(uBox(::g::Fuse::Scripting::V8::Simple::JSObject_typeof(), uPtr(that)->_object)), void();
}
...
{
    ::JSObject* ind2;
    return *__retval = uBox(::g::Fuse::Scripting::V8::Simple::JSObject_typeof(), (ind2 = __this->_object, ind2), alloca(::g::Fuse::Scripting::V8::Simple::JSObject_typeof()->ObjectSize))->GetHashCode(), void();
}
                    ...
                    {
                        {
                            ...
                            for (int32_t i = 0; i < len; ++i)
                            {
                                ...
                                if (::g::Uno::String::op_Equality(strProp, nullptr))
