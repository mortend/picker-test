...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.WebSockets/WebSocketModule.uno
// ---------------------------------------------------------------------------
...
static void NativeFunctionModule__FunctionClosure_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), uObject_typeof()->Array(), uObject_typeof(), nullptr), offsetof(NativeFunctionModule__FunctionClosure, _callback), 0);
}
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.WebSockets/WebSocketClient.uno
// ---------------------------------------------------------------------------
...
{
    uPtr(uPtr(result)->GetObject(c))->Item(uString::Const("exports"), NativeFunctionModule__FunctionClosure::New1(c, uDelegate::New(::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::TYPES[6/*object[]*/], uObject_typeof(), nullptr), __this, offsetof(NativeFunctionModule_type, fp_Create)))->Callback());
}
...
void NativeFunctionModule::ctor_2(uString* name)
{
    ...
    if (NativeFunctionModule::_instance_ != nullptr)
        return;
...
static void WebSocketClient_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), nullptr);
    ::TYPES[4] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Byte_typeof()->Array(), nullptr);
    type->SetFields(0,
...
{
    if (::g::Uno::Delegate::op_Inequality(Closed, nullptr))
...
{
    if (::g::Uno::Delegate::op_Inequality(ErrorReceived, nullptr))
...
{
    if (::g::Uno::Delegate::op_Inequality(Opened, nullptr))
...
{
    if (::g::Uno::Delegate::op_Inequality(DataReceived, nullptr))
...
{
    if (::g::Uno::Delegate::op_Inequality(MessageReceived, nullptr))
...
{
    return *__retval = ::g::Fuse::WebSocket::WebSocketClientWrapper::New3(args)->EvaluateExports(context, nullptr), void();
}
...
static void WebSocketClientWrapper_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Action1_typeof()->MakeType(::TYPES[7/*string*/], nullptr);
    ::TYPES[4] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Byte_typeof()->Array(), nullptr);
    ::TYPES[2] = ::g::Uno::Action_typeof();
...
void WebSocketClientWrapper::ctor_3(uArray* args)
{
    ...
    uString* uri = (uPtr(args)->Length() > 0) ? uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[7/*string*/]) : nullptr;

    if (::g::Uno::String::op_Equality(uri, nullptr))
...
uObject* WebSocketClientWrapper::Send(::g::Fuse::Scripting::Context* c, uArray* args)
{
    if ((args != nullptr) && (uPtr(args)->Length() > 0))
    {
        ...
        else
        {
            ...
            if ((obj != nullptr) && (uPtr(obj)->Item(::STRINGS[9/*"buffer"*/]) != nullptr))
            {
