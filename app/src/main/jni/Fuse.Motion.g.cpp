...
#include <Fuse.Motion.DelayFunc-2b5d97bc.h>
#include <Fuse.Motion.DelayFunc-ab74ebd9.h>
...
#include <Fuse.Motion.MotionDes-4a180bd0.h>
...
#include <Fuse.Motion.SpringFun-2d32ba60.h>
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Motion/DelayFunction.uno
// ---------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Motion/DestinationMotion.uno
// -------------------------------------------------------------------------
...
static void DestinationMotionConfig_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/morten/fuse-open/fuselibs/Source/Fuse.Motion/DestinationMotion.uno");
    ...
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[1/*Fuse.Motion.Simulation.EasingMotion`1*/]->MakeType(type->MethodTypes[0]->U(0), nullptr),
        ::TYPES[2/*Fuse.Motion.Simulation.ElasticForce`1*/]->MakeType(type->MethodTypes[0]->U(0), nullptr),
        ::TYPES[3/*Fuse.Motion.Simulation.SmoothSnap`1*/]->MakeType(type->MethodTypes[0]->U(0), nullptr),
        ::TYPES[4/*Fuse.Motion.Simulation.AngularAdapter`1*/]->MakeType(type->MethodTypes[0]->U(0), nullptr),
        ::TYPES[5/*Fuse.Motion.Simulation.AdapterMultiplier`1*/]->MakeType(type->MethodTypes[0]->U(0), nullptr));
    type->SetFields(0,
...
uObject* DestinationMotionConfig::Create(uType* __type)
{
    ...
    switch (Type())
    {
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[0/*"Invalidate ...*/], uBox<int32_t>(::g::Fuse::Motion::MotionDestinationType_typeof(), Type())), this, ::STRINGS[1/*"/Users/mort...*/], 170, ::STRINGS[2/*"Create"*/], nullptr);
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Motion/MotionConfig.uno
// --------------------------------------------------------------------
...
{
    ::TYPES[6] = ::g::Fuse::Motion::DestinationMotion_typeof()->MakeType(::g::Uno::Float2_typeof(), nullptr);
    ::TYPES[7] = ::g::Fuse::Motion::Simulation::Friction_typeof()->MakeType(::g::Uno::Float2_typeof(), nullptr);
    type->SetFields(0,
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Motion/Enums.uno
// -------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/Source/Fuse.Motion/SpringFunction.uno
// ----------------------------------------------------------------------
...
{
    ::TYPES[10] = ::g::Fuse::Motion::Simulation::ElasticForce_typeof()->MakeType(::g::Uno::Float4_typeof(), nullptr);
