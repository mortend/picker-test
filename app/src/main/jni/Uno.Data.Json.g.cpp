...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/Uno.Data.Json/2.2.0/Source/JsonValue.uno
// ---------------------------------------------------------------------------------------------------------------
...
{
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Data::Json::Value_typeof(), nullptr);
    type->SetFields(0,
...
{
    return *__retval = ::g::Uno::Object::ToString(uBoxPtr(__this->__type->GetBase(AtomicValue_typeof())->T(0), uPtr(__this->_val()), alloca(__this->__type->GetBase(AtomicValue_typeof())->T(0)->ObjectSize))), void();
}
...
{
    type->SetBase(::g::Uno::Data::Json::AtomicValue_typeof()->MakeType(::g::Uno::Bool_typeof(), nullptr));
    type->SetFields(1,
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/Uno.Data.Json/2.2.0/Source/JsonDataType.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/Uno.Data.Json/2.2.0/Source/JsonException.uno
// -------------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/Uno.Data.Json/2.2.0/Source/JsonReader.uno
// ----------------------------------------------------------------------------------------------------------------
...
JsonReader* JsonReader::Item1(uString* key)
{
    ...
    if ((obj == nullptr) || !uPtr(obj)->ContainsKey(key))
        return nullptr;
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/Uno.Data.Json/2.2.0/Source/JsonWriter.uno
// ----------------------------------------------------------------------------------------------------------------
...
{
    type->SetBase(::g::Uno::Data::Json::AtomicValue_typeof()->MakeType(::g::Uno::Double_typeof(), nullptr));
    type->SetFields(1);
}
...
{
    ::TYPES[9] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Data::Json::Value_typeof(), nullptr);
    ::TYPES[10] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(5/*ToArray<string>*/, ::g::Uno::String_typeof(), nullptr);
    type->SetFields(0,
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/Uno.Data.Json/2.2.0/Source/Parser.uno
// ------------------------------------------------------------------------------------------------------------
...
{
    type->SetBase(::g::Uno::Data::Json::AtomicValue_typeof()->MakeType(::g::Uno::String_typeof(), nullptr));
    type->SetFields(1);
}
