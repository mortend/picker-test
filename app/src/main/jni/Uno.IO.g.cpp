...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/Bundle.uno
// -------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/BinaryReader.uno
// -------------------------------------------------------------------------------------------------------------------
...
static void Bundle_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("The file '");
    ::STRINGS[6] = uString::Const("' was not found in bundle '");
    ::STRINGS[7] = uString::Const("'");
    ::STRINGS[8] = uString::Const("bundles");
    ::TYPES[2] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), type, nullptr);
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), nullptr);
    ::TYPES[4] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[5] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), nullptr);
    type->SetFields(0,
        ...
        ::g::Uno::Bool_typeof(), (uintptr_t)&Bundle::_loaded_, uFieldFlagsStatic);
}
...
// private Bundle([string packageName], [bool load])
void Bundle__ctor__fn(Bundle* __this, uString* packageName, bool* load)
{
    __this->ctor_(packageName, *load);
}
...
// private Bundle New([string packageName], [bool load])
void Bundle__New1_fn(uString* packageName, bool* load, Bundle** __retval)
{
    *__retval = Bundle::New1(packageName, *load);
}

// public generated string get_PackageName()
void Bundle__get_PackageName_fn(Bundle* __this, uString** __retval)
{
    *__retval = __this->PackageName();
}

// private generated void set_PackageName(string value)
void Bundle__set_PackageName_fn(Bundle* __this, uString* value)
{
    __this->PackageName(value);
}

// public override sealed string ToString()
void Bundle__ToString_fn(Bundle* __this, uString** __retval)
{
    return *__retval = __this->PackageName(), void();
}

uSStrong< ::g::Uno::Collections::Dictionary*> Bundle::_bundles_;
uSStrong< ::g::Uno::Collections::List*> Bundle::_allFiles_;
bool Bundle::_loaded_;

// private Bundle([string packageName], [bool load]) [instance]
void Bundle::ctor_(uString* packageName, bool load)
{
    uArray* array4;
    int32_t index5;
    int32_t length6;
    ...
    for (array4 = ::g::Uno::String::Split(uPtr(::g::Uno::IO::BundleFile::New1(this, nullptr, ::g::Uno::String::op_Addition2(packageName, ::STRINGS[4/*".bundle"*/]))->ReadAllText()), uArray::Init<int32_t>(::TYPES[4/*char[]*/], 1, 10)), index5 = 0, length6 = uPtr(array4)->Length(); index5 < length6; ++index5)
    {
        uString* line = uPtr(array4)->Strong<uString*>(index5);
        uArray* parts = ::g::Uno::String::Split(uPtr(line), uArray::Init<int32_t>(::TYPES[4/*char[]*/], 1, ':'));
        ::g::Uno::IO::BundleFile* file = ::g::Uno::IO::BundleFile::New1(this, uPtr(parts)->Strong<uString*>(0), uPtr(parts)->Strong<uString*>(1));
...
{
    ::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::IO::BundleFile*> > ret10;
    ::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::IO::BundleFile*> > enum7 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_files), &ret10), ret10);

    {
        try
        {
            {
                while (enum7.MoveNext(::TYPES[5/*Uno.Collections.List<Uno.IO.BundleFile>.Enumerator*/]))
                {
                    ::g::Uno::IO::BundleFile* f = enum7.Current(::TYPES[5/*Uno.Collections.List<Uno.IO.BundleFile>.Enumerator*/]);
                    ...
                    if (::g::Uno::String::op_Equality(uPtr(f)->SourcePath(), filename) || ::g::Uno::String::op_Equality(uPtr(f)->BundlePath(), filename))
                    {
                        ...
                        enum7.Dispose(::TYPES[5/*Uno.Collections.List<Uno.IO.BundleFile>.Enumerator*/]);
                        return __uno_retval;
                    }
                }
            }
    ...
    U_THROW(::g::Uno::IO::FileNotFoundException::New5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[5/*"The file '"*/], filename), ::STRINGS[6/*"' was not f...*/]), PackageName()), ::STRINGS[7/*"'"*/]), filename));
}

// public generated string get_PackageName() [instance]
uString* Bundle::PackageName()
{
    return _PackageName;
}

// private generated void set_PackageName(string value) [instance]
void Bundle::PackageName(uString* value)
{
    _PackageName = value;
}
...
Bundle* Bundle::Get(uString* package)
{
    ...
    bool ret9;
    Bundle::Load();
    ::g::Uno::Threading::Monitor::Enter(Bundle::_bundles_);
        ...
        {
            {
                ...
                if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Bundle::_bundles_), package, (void**)(&bundle), &ret9), ret9))
                {
                    bundle = Bundle::New1(package, false);
                    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Bundle::_bundles_), package, bundle);
                }

                Bundle* __uno_retval = bundle;
                ::g::Uno::Threading::Monitor::Exit(Bundle::_bundles_);
                return __uno_retval;
            }
        }
...
// private static void Load() [static]
void Bundle::Load()
{
    Bundle_typeof()->Init();
    uArray* array1;
...

    {
        ...
        {
            {
                for (array1 = ::g::Uno::String::Split(uPtr(::g::Uno::IO::BundleFile::New1(Bundle::New1(nullptr, false), nullptr, ::STRINGS[8/*"bundles"*/])->ReadAllText()), uArray::Init<int32_t>(::TYPES[4/*char[]*/], 1, 10)), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
                {
                    uString* package = uPtr(array1)->Strong<uString*>(index2);
                    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(Bundle::_bundles_), package, Bundle::New1(package, true));
                }
            }
        }
...
// private Bundle New([string packageName], [bool load]) [static]
Bundle* Bundle::New1(uString* packageName, bool load)
{
    Bundle* obj8 = (Bundle*)uNew(Bundle_typeof());
    obj8->ctor_(packageName, load);
    return obj8;
}
...
{
    ::STRINGS[9] = uString::Const("Uno.IO.BundleFile.BundlePath");
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
...
{
    if (::g::Uno::String::op_Equality(BundlePath(), nullptr))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[9/*"Uno.IO.Bund...*/]));
...
{
    uArray* bytes = ReadAllBytes();
    int32_t count = uPtr(bytes)->Length();
    int32_t index = 0;

    if ((((count > 2) && (bytes->Item<uint8_t>(0) == 239)) && (bytes->Item<uint8_t>(1) == 187)) && (bytes->Item<uint8_t>(2) == 191))
    {
        index = 3;
        count = count - 3;
    }

    return ::g::Uno::Text::Utf8::GetString1(bytes, index, count);
}
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/Directory.uno
// ----------------------------------------------------------------------------------------------------------------
...
{
    if (::g::Uno::String::op_Equality(dirName, nullptr))
    ...
    if (mkdir(uCString(dirName).Ptr, S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH) == 0 ||
            errno == EEXIST)
        return;
    U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Unable to create directory '"), dirName), ::STRINGS[7/*"'"*/])));
}
...
void Directory::Delete(uString* dirName, bool recursive)
{
    ...
    if (recursive)
    {
        uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Directory::EnumerateDirectories(dirName)), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), nullptr)));
            ...
            {
                {
                    ...
                    {
                        uString* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof(), nullptr)), &ret3), ret3);
        ...
        uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Directory::EnumerateFiles(dirName)), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), nullptr)));
            ...
            {
                {
                    ...
                    {
                        uString* e1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof(), nullptr)), &ret4), ret4);
    ...
    if (rmdir(cstr.Ptr) != 0)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Unable to delete directory '"), dirName), ::STRINGS[7/*"'"*/])));
}
...
{
    if (::g::Uno::String::op_Equality(oldName, nullptr))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[20/*"oldName"*/]));

    if (::g::Uno::String::op_Equality(newName, nullptr))
    ...
    if (rename(oldNameU8.Ptr, newNameU8.Ptr) != 0)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Unable to move directory '"), oldName), ::STRINGS[23/*"' to '"*/]), newName), ::STRINGS[7/*"'"*/])));
}
// }

// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/DirectoryInfo.uno
// --------------------------------------------------------------------------------------------------------------------
...
{
    type->SetInterfaces(
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), nullptr), offsetof(Directory__Enumerable_type, interface0));
    type->SetFields(0,
...
static void Directory__Enumerator_build(uType* type)
{
    ...
    type->SetDependencies(
        ::g::Uno::IO::Path_typeof());
    type->SetInterfaces(
        ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof(), nullptr), offsetof(Directory__Enumerator_type, interface0),
...
void Directory__Enumerator::ctor_(uString* dirName, int32_t mode)
{
    ...
    _mode = mode;
    _prefix = (::g::Uno::String::op_Inequality(dirName, ::STRINGS[12/*"."*/]) ? (uString*)::g::Uno::String::op_Addition1(dirName, uBox<char16_t>(::g::Uno::Char_typeof(), ::g::Uno::IO::Path::DirectorySeparatorChar())) : ::STRINGS[13/*""*/]);
}
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/File.uno
// -----------------------------------------------------------------------------------------------------------
...
{
    if (::g::Uno::String::op_Equality(sourceFile, nullptr))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[14/*"sourceFile"*/]));

    if (::g::Uno::String::op_Equality(destinationFile, nullptr))
    ...
    if (source == -1)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[16/*"Unable to c...*/], sourceFile), ::STRINGS[7/*"'"*/])));
    ...
    {
        close(source);
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[17/*"Unable to c...*/], destinationFile), ::STRINGS[7/*"'"*/])));
    }
...
void File::Delete(uString* filename)
{
    ...
    if (unlink(cstr.Ptr) != 0)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[19/*"Unable to d...*/], filename), ::STRINGS[7/*"'"*/])));
}
...
void File::Move(uString* oldName, uString* newName)
{
    ...
    if (rename(oldNameU8.Ptr, newNameU8.Ptr) != 0)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[22/*"Unable to m...*/], oldName), ::STRINGS[23/*"' to '"*/]), newName), ::STRINGS[7/*"'"*/])));
}
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/FileAttributes.uno
// ---------------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/FileInfo.uno
// ---------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/FileMode.uno
// ---------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/IOException.uno
// ------------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/FileStream.uno
// -----------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/FileStatus.uno
// -----------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/FileStatusHelpers.Unix.uno
// -----------------------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/FileSystemInfo.uno
// ---------------------------------------------------------------------------------------------------------------------
...
{
    if (::g::Uno::String::op_Equality(originalPath, nullptr))
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/MemoryStream.uno
// -------------------------------------------------------------------------------------------------------------------
...
{
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[9] = ::g::Uno::Array_typeof()->MakeMethod(1/*Copy<byte>*/, ::g::Uno::Byte_typeof(), nullptr);
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::IO::Stream_type, interface0));
    type->SetFields(0,
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/Path.uno
// -----------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[38] = uString::Const("path1");
    ::STRINGS[39] = uString::Const("path2");
    ::TYPES[4] = ::g::Uno::Char_typeof()->Array();
    type->SetFields(0,
...
uString* Path::Combine(uString* path1, uString* path2)
{
    ...
    if (::g::Uno::String::op_Equality(path1, nullptr))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[38/*"path1"*/]));

    if (::g::Uno::String::op_Equality(path2, nullptr))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[39/*"path2"*/]));
...
uString* Path::GetDirectoryName(uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(path, nullptr))
        return nullptr;
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/SeekOrigin.uno
// -----------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/Stream.uno
// -------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/StreamReader.uno
// -------------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[40] = uString::Const("StreamReader");
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[4] = ::g::Uno::Char_typeof()->Array();
    type->SetInterfaces(
...
void StreamReader__Dispose1_fn(StreamReader* __this, bool* disposing)
{
    ...
    if (disposing_ && (__this->_stream != nullptr))
    {
        uPtr(__this->_stream)->Close();
        __this->_stream = nullptr;
    }
...
{
    if (__this->_stream == nullptr)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[40/*"StreamReader"*/]));
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/StreamWriter.uno
// -------------------------------------------------------------------------------------------------------------------
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/StringReader.uno
// -------------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[41] = uString::Const("StringReader");
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::IO::TextReader_type, interface0));
    type->SetFields(0,
...
{
    if (::g::Uno::String::op_Equality(__this->_string, nullptr))
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[41/*"StringReader"*/]));
...
void StringReader::ctor_1(uString* text)
{
    ...
    _string = text;
    _index = 0;
    _length = (::g::Uno::String::op_Equality(text, nullptr) ? 0 : uPtr(text)->Length());
}
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/TextReader.uno
// -----------------------------------------------------------------------------------------------------------------
...
{
    ::TYPES[10] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Char_typeof(), nullptr);
    type->SetInterfaces(
...
// /Users/morten/fuse-open/fuselibs/node_modules/@fuse-open/uno/lib/build/UnoCore/2.2.0/Source/Uno/IO/TextWriter.uno
// -----------------------------------------------------------------------------------------------------------------
